...
contract Random is VRFConsumerBaseV2, ConfirmedOwner {
    ...
    function getRequestStatus() public view returns (uint256 randomWords) {
        ...
        uint256 randomNum = (randomWord % 10)+1;
        return randomNum;
    }
...
// 0xD730CFd9ab76322DC0CC3615d9A8e7Af779fA700
